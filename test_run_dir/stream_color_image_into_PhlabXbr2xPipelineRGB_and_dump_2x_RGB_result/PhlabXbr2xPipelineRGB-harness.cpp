...
#define TOP_CLASS VPhlabXbr2xPipelineRGB
...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/phlab/Pixel-art-scaling-Accelerator-in-Chisel-upgrade-main/test_run_dir/stream_color_image_into_PhlabXbr2xPipelineRGB_and_dump_2x_RGB_result/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 2 : dut->io_in_bits_pix = u; break;
      case 3 : dut->io_in_bits_sof = u; break;
      case 4 : dut->io_in_bits_eol = u; break;
      case 5 : dut->io_out_ready = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 2 : value = dut->io_in_bits_pix; break;
      case 3 : value = dut->io_in_bits_sof; break;
      case 4 : value = dut->io_in_bits_eol; break;
      case 5 : value = dut->io_out_ready; break;
      case 6 : value = dut->io_in_ready; break;
      case 7 : value = dut->io_out_valid; break;
      case 8 : value = dut->io_out_bits_block_0; break;
      case 9 : value = dut->io_out_bits_block_1; break;
      case 10 : value = dut->io_out_bits_block_2; break;
      case 11 : value = dut->io_out_bits_block_3; break;
      case 12 : value = dut->io_out_bits_x; break;
      case 13 : value = dut->io_out_bits_y; break;
      case 14 : value = dut->io_out_bits_sof; break;
      case 15 : value = dut->io_out_bits_eol; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/phlab/Pixel-art-scaling-Accelerator-in-Chisel-upgrade-main/test_run_dir/stream_color_image_into_PhlabXbr2xPipelineRGB_and_dump_2x_RGB_result/PhlabXbr2xPipelineRGB.)";
